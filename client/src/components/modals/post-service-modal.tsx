...
import { X, Upload, Search, Coins } from "lucide-react";
...
interface PostServiceModalProps {
  isOpen: boolean;
  onClose: () => void;
  editingService?: ServiceData & { id: string };
  isEditing?: boolean;
}
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: isEditing 
          ...
          : "Your service has been submitted for admin approval. You'll be notified once it's reviewed. 10 coins have been deducted.",
      });
      onClose();
      resetForm();
    },
                ...
                <span className="flex items-center justify-center gap-1">
                  {createServiceMutation.isPending ? (
                    ...
                    <>
                      ...
                      <span className="ml-1">
                        {isEditing ? "5" : "10"}<Coins className="h-4 w-4 inline text-yellow-500 ml-0.5" />
                      </span>
                    </>
                  )}
                </span>
