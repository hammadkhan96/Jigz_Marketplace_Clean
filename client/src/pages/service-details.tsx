...
import type { ServiceWithRequests, UserWithStats, User as UserType, ReviewWithUser } from "@shared/schema";
...
import { ObjectUploader } from "@/components/ui-components/object-uploader";
...
export default function ServiceDetailsPage() {
  ...
  const { data: providerReviews } = useQuery<ReviewWithUser[]>({
