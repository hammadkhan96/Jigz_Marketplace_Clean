...
import { getGoogleCallbackUrl } from "./config/environment";
...
// Password hashing utilities - now imported from config/bcrypt
  ...
  if (GOOGLE_CLIENT_ID && GOOGLE_CLIENT_SECRET) {
    ...
    app.get('/api/auth/google/callback',
      ...
      (req, res) => {
        ...
        res.redirect(`${frontendUrl}/?login=success&provider=google`);
      }
    );
  } else {
